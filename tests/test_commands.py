...
def test_hash_object_command_file_not_found(
...
def test_hash_object_command_success(
    sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_hash_object_command_with_write(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
    ...
    obj = read_object(output_hash)
    assert obj["type"] == "blob"
    assert obj["content"] == sample_file.read_bytes()


def test_cat_file_command_not_found(
...
def test_cat_file_command_show_content(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_cat_file_command_show_type(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_cat_file_command_show_size(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_status_command_with_staged_files(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_status_command_with_untracked_files(
    initialized_repo: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_commit_command_success(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_commit_command_with_parent(
    initialized_repo: Path, multiple_files: list[Path], capsys: CaptureFixture[str]
) -> None:
...
def test_checkout_command_invalid_commit(
    initialized_repo: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_checkout_command_not_a_commit(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_log_command_no_commits(
    initialized_repo: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_log_command_single_commit(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_log_command_multiple_commits(
    initialized_repo: Path, multiple_files: list[Path], capsys: CaptureFixture[str]
) -> None:
...
def test_add_command_file_deletion(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_add_command_file_deletion_not_tracked(
    initialized_repo: Path, capsys: CaptureFixture[str]
) -> None:
...
def test_commit_with_file_deletion(
    initialized_repo: Path, sample_file: Path, capsys: CaptureFixture[str]
) -> None:
